      ...
      <div className="section-container">
        ...
        <div ref={gridRef} className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {SERVICES.map((s) => (
            <div
              key={s.title}
              className="group glass-card p-8 hover:-translate-y-2 transition-all duration-300 hover:border-amber-500/30 hover:shadow-[0_0_28px_rgba(245,158,11,0.10)]"
            >
...
const offlineMarketingItems = [
  ...
  },
  {
    ...
    title: '🎨 Content Creation (Graphics, Printing & Audio-Visuals)',
...
const DigitalMarketingPreviewSection = () => {
...
const DigitalMarketing = () => (
  <div className="bg-primary">
    ...
    <Hero />
    <DigitalMarketingPreviewSection />
    <ServicesGrid />
    <StorySection />
    <ReelsSection />
    <StaticsSection />
    ...
    <div className="section-container pb-24">
      ...
      <div className="mt-20 text-center glass-card p-12 rounded-3xl border-borderSubtle hover:border-accent/20 transition-all duration-300">
        <h3 className="text-3xl font-heading font-bold text-textPrimary mb-4">Ready to Scale Your Brand?</h3>
